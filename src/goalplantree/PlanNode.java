...
public class PlanNode extends TreeNode {
     ...
     */
    public PlanNode(String id, String type, Condition[] preconditions, Condition[] inconditions, Condition[] postconditions, TreeNode[] nodes){
        super(id, type);
        this.prec = preconditions == null ? new Condition[0] : preconditions;
        this.inc = inconditions == null ? new Condition[0] : inconditions;
        this.postc = postconditions == null ? new Condition[0] : postconditions;
    ...
    public PlanNode(String id, PlanTemplate pt){
        ...
        this.postc = pt.postc == null ? new Condition[0] : pt.postc;
