...
public class PlanNode extends Node
{
	...
	/** prerequisite list */
	private ArrayList<Node> preqList = new ArrayList<>();

	/** dependent list*/
	private ArrayList<Node> depList = new ArrayList<>();
	...
	/** method to return the list of prerequisite step of this node, which is the goal this plan is going to achieve */
	@Override
	public ArrayList<Node> getPreqList(){
		return preqList;
	}

	/**
	 * @return the list of dependent step of this plan, i.e., what steps are available to execute at the beginning
	 */
	@Override
	public ArrayList<Node> getDepList(){
		return depList;
	}
