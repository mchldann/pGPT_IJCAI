...
{	
	...
	private void writePlan(PlanNode pl, Element parent)
	{
		...
		// prerequisite
		ArrayList<Node> list = pl.getPreqList();
		if(list != null && list.size() > 0){
			StringBuilder preq = new StringBuilder();
			for(int i = 0; i < list.size(); i++){
				//if(i > 0){
				//	preq.append(", ");
				//}
				preq.append(list.get(i).getName());
				preq.append(";");
				plan.setAttribute(new Attribute("prerequisite", preq.toString()));
			}
		}
		...
		if(list != null && list.size() > 0){
			...
			for(int i = 0; i < list.size(); i++){
				...
				//	dep.append(", ");
				//}
				dep.append(list.get(i).getName());
				dep.append(";");
				plan.setAttribute(new Attribute("dependent", dep.toString()));
			}
		}
	...
	private void writeAction(ActionNode act, Element parent)
	{
		...
		// prerequisite
		ArrayList<Node> list = act.getPreqList();
		if(list != null && list.size() > 0){
			StringBuilder preq = new StringBuilder();
			for(int i = 0; i < list.size(); i++){
				//if(i > 0){
				...
				preq.append(list.get(i).getName());
				preq.append(";");
				action.setAttribute(new Attribute("prerequisite", preq.toString()));
			}
		}
		...
		if(list != null && list.size() > 0){
			...
			for(int i = 0; i < list.size(); i++){
				...
				dep.append(list.get(i).getName());
				dep.append(";");
				action.setAttribute(new Attribute("dependent", dep.toString()));
			}
		}
	...
	private void writeGoal(GoalNode gl, Element parent)
	{
		...
		// prerequisite
		ArrayList<Node> list = gl.getPreqList();
		if(list != null && list.size() > 0){
			StringBuilder preq = new StringBuilder();
			for(int i = 0; i < list.size(); i++){
				//if(i > 0){
				...
				preq.append(list.get(i).getName());
				preq.append(";");
				goal.setAttribute(new Attribute("prerequisite", preq.toString()));
			}
		}
		...
		if(list != null && list.size() > 0){
			...
			for(int i = 0; i < list.size(); i++){
				...
				dep.append(list.get(i).getName());
				dep.append(";");
				goal.setAttribute(new Attribute("dependent", dep.toString()));
			}
		}
